...
/***/ function(module, exports, __webpack_require__) {
	...
	var _osilliscopeVisualiztion = __webpack_require__(/*! ./osilliscopeVisualiztion */ 159);
	
	var _osilliscopeVisualiztion2 = _interopRequireDefault(_osilliscopeVisualiztion);
	
	var _envelopeGenerator = __webpack_require__(/*! ./envelopeGenerator */ 161);
	
	var _envelopeGenerator2 = _interopRequireDefault(_envelopeGenerator);
	
	var _filters = __webpack_require__(/*! ./filters */ 163);
	
	var _filters2 = _interopRequireDefault(_filters);
	
	var _freqBarVisualisation = __webpack_require__(/*! ./freqBarVisualisation */ 164);
	
	var _freqBarVisualisation2 = _interopRequireDefault(_freqBarVisualisation);
	
	var _keyboard = __webpack_require__(/*! ./keyboard */ 165);
	
	var _keyboard2 = _interopRequireDefault(_keyboard);
	
	var _waveFormCtrl = __webpack_require__(/*! ./waveFormCtrl */ 166);
	
	var _waveFormCtrl2 = _interopRequireDefault(_waveFormCtrl);
	...
	var Synth = _react2.default.createClass({
	  displayName: 'Synth',
	  ...
	  onMIDIFailure: function onMIDIFailure() {
	    console.log("Cannot connect: ", e);
	  },
	
	  onMidiMessage: function onMidiMessage(midiEvent) {
	  ...
	  noteToFreq: function noteToFreq(note) {
	    return 440 * Math.pow(2, (note - 69) / 12);
	  },
	
	  processMessage: function processMessage(onOrOff, note, velocity) {
	    var index;
	    var nextState;
	  ...
	  envOn: function envOn(vcaGain, attackVal, decayVal, sustainVal) {
	  ...
	  envOff: function envOff(vcaGain, releaseVal, osc, note) {
	    var currTime = this.context.currentTime;
	  ...
	  onNote: function onNote(note, velocity) {
	  ...
	  offNote: function offNote(note, velocity) {
	    var osc = this.keys[note];
	    var currTime = this.context.currentTime;
	  ...
	  updateEnvelopeValues: function updateEnvelopeValues(name, value) {
	    if (name === 'attack') {
	  ...
	  updateEnvelopeMode: function updateEnvelopeMode(mode) {
	    this.setState({ egMode: mode });
	  },
	
	  updateVolumeLevel: function updateVolumeLevel(volume) {
	    this.master.gain.value = volume;
	    this.setState({ volume: volume });
	  },
	
	  updateFilter: function updateFilter(name, value) {
	  ...
	  updateWaveForm: function updateWaveForm(newValue) {
	  ...
	  updateDistortionValue: function updateDistortionValue(distortion) {
	    if (distortion === 'on') {
	  ...
	  toggleViz: function toggleViz(newValue) {
	  ...
	  render: function render() {
	    ...
	    if (this.state.visualisation === 'frequency') {
	      viz = _react2.default.createElement(_freqBarVisualisation2.default, {
	        analyser: this.analyser,
	        toggleViz: this.toggleViz,
	        updateWaveForm: this.updateWaveForm
	      });
	    } else {
	      viz = _react2.default.createElement(_osilliscopeVisualiztion2.default, {
	        analyser: this.analyser,
	        toggleViz: this.toggleViz,
	        updateWaveForm: this.updateWaveForm
	      });
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { id: 'logo' },
	        _react2.default.createElement('img', { src: '../../../images/midi_synth_opti_gray.png' })
	      ),
	      _react2.default.createElement(
	        'div',
	        { id: 'controls' },
	        ...
	        _react2.default.createElement(_waveFormCtrl2.default, {
	...
	(0, _reactDom.render)(_react2.default.createElement(Synth, null), document.getElementById('container'));
...
/* 159 */
/*!***************************************************!*\
  !*** ./src/client/app/osilliscopeVisualiztion.js ***!
  \***************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _visualisationCtrl = __webpack_require__(/*! ./visualisationCtrl */ 160);
	
	var _visualisationCtrl2 = _interopRequireDefault(_visualisationCtrl);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var OsilliscopeVisualiztion = _react2.default.createClass({
	  displayName: 'OsilliscopeVisualiztion',
	  ...
	  drawOscilliscope: function drawOscilliscope() {
	    var data;
	    var width;
	    var length;
	    var width;
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      'div',
	      { className: 'viz' },
	      _react2.default.createElement('canvas', { id: 'canvas', width: '400', height: '200' }),
	      _react2.default.createElement(_visualisationCtrl2.default, {
	...
	exports.default = OsilliscopeVisualiztion;

/***/ },
/* 160 */
/*!*********************************************!*\
  !*** ./src/client/app/visualisationCtrl.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var VisualisationCtrl = _react2.default.createClass({
	  displayName: 'VisualisationCtrl',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'form',
	        { id: 'vis-control', onChange: this.handleChange },
	        _react2.default.createElement(
	          'label',
	          null,
	          ' Frequency Bars',
	          _react2.default.createElement('input', { id: 'freq-bars', type: 'radio', name: 'viz', value: 'frequency' })
	        ),
	        _react2.default.createElement(
	          'label',
	          null,
	          ' Oscilliscope',
	          _react2.default.createElement('input', { id: 'oscilliscope', type: 'radio', name: 'viz', value: 'oscilliscope', defaultChecked: true })
	        )
	      )
	    );
	  }
	...
	exports.default = VisualisationCtrl;

/***/ },
/* 161 */
/*!*********************************************!*\
  !*** ./src/client/app/envelopeGenerator.js ***!
  \*********************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _envelopeModes = __webpack_require__(/*! ./envelopeModes */ 162);
	
	var _envelopeModes2 = _interopRequireDefault(_envelopeModes);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var EnvelopeGenerator = _react2.default.createClass({
	  displayName: 'EnvelopeGenerator',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'env-ctrl-right' },
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Attack',
	            _react2.default.createElement('input', { onChange: this.handleChange, id: 'attack', type: 'range', min: '0', max: '1', step: '0.05', value: this.props.attack, name: 'attack', defaultValue: true })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Decay',
	            _react2.default.createElement('input', { onChange: this.handleChange, id: 'decay', type: 'range', min: '0', max: '1', step: '0.05', value: this.props.decay, name: 'decay', defaultValue: true })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'env-ctrl-left' },
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Sustain',
	            _react2.default.createElement('input', { onChange: this.handleChange, id: 'sustain', type: 'range', min: '0', max: '1', step: '0.05', value: this.props.sustain, name: 'sustain', defaultValue: true })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Release',
	            _react2.default.createElement('input', { onChange: this.handleChange, id: 'release', type: 'range', min: '0', max: '1', step: '0.05', value: this.props.release, name: 'release', defaultValue: true })
	          )
	        )
	      ),
	      _react2.default.createElement(_envelopeModes2.default, { updateEnvelopeMode: this.props.updateEnvelopeMode })
	    );
	  }
	});
	
	exports.default = EnvelopeGenerator;

/***/ },
/* 162 */
/*!*****************************************!*\
  !*** ./src/client/app/envelopeModes.js ***!
  \*****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var EnvelopeModes = _react2.default.createClass({
	  displayName: 'EnvelopeModes',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'form',
	        { id: 'egModeCtrl', onChange: this.handleChange },
	        _react2.default.createElement(
	          'label',
	          null,
	          ' High',
	          _react2.default.createElement('input', { id: 'eg-high', type: 'radio', name: 'egMode', value: '10' })
	        ),
	        _react2.default.createElement(
	          'label',
	          null,
	          ' Medium',
	          _react2.default.createElement('input', { id: 'eg-medium', type: 'radio', name: 'egMode', value: '5' })
	        ),
	        _react2.default.createElement(
	          'label',
	          null,
	          ' Low',
	          _react2.default.createElement('input', { id: 'eg-low', type: 'radio', name: 'egMode', value: '1', defaultChecked: true })
	        )
	      )
	    );
	  }
	...
	var Filters = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'form',
	        { id: 'filter-one', onChange: this.handleChange },
	        _react2.default.createElement(
	          'h3',
	          null,
	          'Filter 1'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' High-Pass',
	            _react2.default.createElement('input', { className: 'high-pass filter-input', type: 'radio', name: 'filter-one', value: 'highpass', defaultChecked: true })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Low-Pass',
	            _react2.default.createElement('input', { className: 'low-pass filter-input', type: 'radio', name: 'filter-one', value: 'lowpass' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Band-Pass',
	            _react2.default.createElement('input', { className: 'band-pass filter-input', type: 'radio', name: 'filter-one', value: 'bandpass' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          { className: 'cutoff-freq' },
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Cutoff frequency:',
	            _react2.default.createElement('input', { className: 'filter-freq', type: 'range', min: '0', max: '5000', step: '100', value: this.props.filterOneCutOffFreq, name: 'filter-freq-one' })
	          )
	        )
	      ),
	      _react2.default.createElement(
	        'form',
	        { id: 'filter-two', onChange: this.handleChange },
	        _react2.default.createElement(
	          'h3',
	          null,
	          'Filter 2'
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' High-Pass',
	            _react2.default.createElement('input', { className: 'high-pass', type: 'radio', name: 'filter-two', value: 'highpass', defaultChecked: true })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Low-Pass',
	            _react2.default.createElement('input', { className: 'low-pass', type: 'radio', name: 'filter-two', value: 'lowpass' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Band-Pass',
	            _react2.default.createElement('input', { className: 'band-pass', type: 'radio', name: 'filter-two', value: 'bandpass' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Cutoff frequency:',
	            _react2.default.createElement('input', { className: 'filter-freq', type: 'range', min: '0', max: '5000', step: '100', value: this.props.filterTwoCutOffFreq, name: 'filter-freq-two' })
	          )
	        )
	      )
	    );
...
/* 164 */
/*!************************************************!*\
  !*** ./src/client/app/freqBarVisualisation.js ***!
  \************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var FreqBarVisualisation = _react2.default.createClass({
	  displayName: 'FreqBarVisualisation',
	  ...
	  drawFreqData: function drawFreqData() {
	...
	exports.default = FreqBarVisualisation;

/***/ },
/* 165 */
/*!************************************!*\
  !*** ./src/client/app/keyboard.js ***!
  \************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Keyboard = _react2.default.createClass({
	  ...
	  render: function render() {
	    ...
	    var keyElms = keys.map(function (key, index) {
	      ...
	      return _react2.default.createElement('div', { id: note, className: className, key: index });
	    }, this);
...
/* 166 */
/*!****************************************!*\
  !*** ./src/client/app/waveFormCtrl.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var _distortion = __webpack_require__(/*! ./distortion */ 167);
	
	var _distortion2 = _interopRequireDefault(_distortion);
	
	var _masterVolume = __webpack_require__(/*! ./masterVolume */ 168);
	
	var _masterVolume2 = _interopRequireDefault(_masterVolume);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var WaveFormCtrl = _react2.default.createClass({
	  displayName: 'WaveFormCtrl',
	  ...
	  render: function render() {
	    ...
	    return _react2.default.createElement(
	      'div',
	      { id: 'volume' },
	      _react2.default.createElement(_masterVolume2.default, {
	        updateVolumeLevel: this.props.updateVolumeLevel,
	        volume: this.props.volume
	      }),
	      _react2.default.createElement(_distortion2.default, {
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'form',
	          { id: 'wave-form', onChange: this.handleChange },
	          _react2.default.createElement(
	            'h3',
	            { className: 'center-wave' },
	            'Wave Form'
	          ),
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Sine',
	            _react2.default.createElement('input', { id: 'sine', type: 'radio', name: 'wave-form', value: 'sine' })
	          ),
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Sawtooth',
	            _react2.default.createElement('input', { id: 'sawtooth', type: 'radio', name: 'wave-form', value: 'sawtooth' })
	          ),
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Square',
	            _react2.default.createElement('input', { id: 'square', type: 'radio', name: 'wave-form', value: 'square', defaultChecked: true })
	          ),
	          _react2.default.createElement(
	            'label',
	            null,
	            ' Triangle',
	            _react2.default.createElement('input', { id: 'triangle', type: 'radio', name: 'wave-form', value: 'triangle' })
	          )
	        )
	      )
	    );
	...
	exports.default = WaveFormCtrl;

/***/ },
/* 167 */
/*!**************************************!*\
  !*** ./src/client/app/distortion.js ***!
  \**************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var Distortion = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'div',
	          { className: 'distortion-ctrl' },
	          _react2.default.createElement(
	            'label',
	            null,
	            ' On',
	            _react2.default.createElement('input', { type: 'radio', name: 'distortion', value: 'on' })
	          )
	        ),
	        _react2.default.createElement(
	          'div',
	          ...
	          _react2.default.createElement(
	            ...
	            null,
	            ' Off',
	            _react2.default.createElement('input', { type: 'radio', name: 'distortion', value: 'off', defaultChecked: true })
	          )
	        )
	      )
	    );
...
/* 168 */
/*!****************************************!*\
  !*** ./src/client/app/masterVolume.js ***!
  \****************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var MasterVolume = _react2.default.createClass({
	  displayName: 'MasterVolume',
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement('input', { onChange: this.handleChange, id: 'master-gain', type: 'range', min: '0', max: '1', step: '0.1', value: this.props.volume })
	      )
	    );
	  }
	});
	
	exports.default = MasterVolume;
